...
import { AssignmentShift, AssignmentStatus, AssignmentValidation } from '../models/assignment-status.type';
...
/**
 * Legacy class kept for compatibility with previous components while the module
 * migrates to the new DDD-oriented AssignmentEntity model.
 */
